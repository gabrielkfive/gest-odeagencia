...
const CLIENTES_CTX: { id: string; nm: string; seg: string; nota: string }[] = [
  ...
  { id: "the-guste", nm: "Pizzaria The Guste", seg: "Pizzaria", nota: "Cliente NOVO (jul/2026): onboarding, primeira linha editorial e primeiras captações." },
  { id: "cafe-lumiere", nm: "Café Lumiere", seg: "Cafeteria", nota: "Cliente NOVO (jul/2026): onboarding, posicionamento e presença inicial." },
