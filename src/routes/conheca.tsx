...
import {
  ...
  PAPEIS,
  PRODUTO,
} from "@/components/landing/conteudo";
...
export const Route = createFileRoute("/conheca")({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Sora:wght@700;800&display=swap",
      },
    ],
  }),
  component: Conheca,
...
const ICONES: Record<string, string> = {
  ...
  moeda:
    "M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM12 7v10M9.5 9.5h3.75a1.75 1.75 0 0 1 0 3.5h-2.5a1.75 1.75 0 0 0 0 3.5H14.5",
  ...
  const cols: { t: string; cards: { t: string; r: string; extra?: string }[] }[] = [
    {
      t: "Andamento",
      cards: [
        { t: "Reels de inauguração, corte final", r: "D", extra: "01:12:40" },
        { t: "Roteiro do carrossel de setembro", r: "C" },
      ],
    },
    { t: "Homologação", cards: [{ t: "Proposta da clínica, revisão", r: "S" }] },
    {
      t: "Homologação do cliente",
      cards: [{ t: "Feed da semana, 4 peças", r: "G", extra: "link enviado" }],
    },
  ];
  return (
    <div className="lc-quadro" aria-label="Ilustração do Kanban de Atividades">
          ...
          <div className="lc-col" key={c.t}>
            ...
            {c.cards.map((k) => (
              <div className="lc-card" key={k.t}>
                ...
                <div className="lc-card-m">
                  <i>{k.r}</i>
                  {k.extra ? <em>{k.extra}</em> : <span>hoje</span>}
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="lc-quadro-legenda">
        Ilustração com as colunas reais do quadro. A demonstração mostra o sistema de verdade.
      </div>
    </div>
  );
}
    ...
    <div className="lc-pagina">
      ...
      <main>
        ...
        <section className="lc-hero" aria-labelledby="hero-titulo">
          <div className="lc-wrap lc-hero-grid">
            <div className="lc-hero-texto">
              ...
              <h1 className="lc-h1" id="hero-titulo">
                Sua agência inteira. <span className="lc-destaque">No mesmo fluxo.</span>
              </h1>
              <p className="lc-lead">
                Produção, clientes, aprovações, comercial e financeiro num lugar só, com
                sincronização entre computador e celular. É o sistema que a ARK Content usa todo dia
                na própria operação, agora aberto para outras agências.
              </p>
        ...
        <section className="lc-sec" id="produto" aria-labelledby="produto-titulo">
          <div className="lc-wrap">
            <div className="lc-cabeca">
              ...
              <h2 className="lc-h2" id="produto-titulo">
                Tudo abaixo está em uso na ARK. Nada de roteiro futuro disfarçado de recurso.
              </h2>
              <p className="lc-p lc-p-max">
                Doze módulos, um estado só. O que a equipe muda no celular aparece no computador em
                segundos, item por item.
              </p>
            </div>
            <div className="lc-grade">
              {PRODUTO.map((b, i) => (
                <article className="lc-bloco" key={b.titulo}>
                  <div className="lc-bloco-ico">
                    <Icone nome={ORDEM_ICONES[i] || "brilho"} />
                  </div>
        ...
        <section className="lc-sec lc-sec-escura" id="jornada" aria-labelledby="jornada-titulo">
          <div className="lc-wrap">
            <div className="lc-cabeca">
              ...
              <h2 className="lc-h2" id="jornada-titulo">
                Do briefing ao relatório, cada passo aponta para uma tela que existe.
              </h2>
            </div>
        ...
        <section className="lc-sec" id="papeis" aria-labelledby="papeis-titulo">
          <div className="lc-wrap">
            <div className="lc-cabeca">
              ...
              <h2 className="lc-h2" id="papeis-titulo">
                Cada pessoa abre o sistema e encontra a parte dela.
              </h2>
              <p className="lc-p lc-p-max">
                Situações do dia a dia da agência. Sem promessa de economia que não foi medida.
              </p>
            </div>
            <div className="lc-grade">
              {PAPEIS.map((b) => (
                <article className="lc-bloco" key={b.titulo}>
                  <h3 className="lc-h3">
                    <span className="lc-destaque">{b.titulo}</span>
                  </h3>
                  <p className="lc-p">{b.texto}</p>
                </article>
              ))}
        ...
        <section className="lc-sec lc-sec-escura" id="ia" aria-labelledby="ia-titulo">
          <div className="lc-wrap">
            <div className="lc-cabeca">
              ...
              <h2 className="lc-h2" id="ia-titulo">
                Agentes propõem. Pessoas decidem.
              </h2>
              <p className="lc-p lc-p-max">
                A camada de IA do WorkFlowArk não publica, não manda mensagem para cliente e não
                move o funil sozinha. Ela prepara o trabalho e espera o clique de alguém da equipe.
              </p>
            </div>
            <div className="lc-ia">
        ...
        <section className="lc-sec" id="prova" aria-labelledby="prova-titulo">
          <div className="lc-wrap">
            ...
            <h2 className="lc-h2" id="prova-titulo">
              Uma prova só, e ela é verificável na demonstração.
            </h2>
            <div className="lc-prova">
              <p>
                A ARK Content usa o WorkFlowArk todo dia na própria operação, no computador e no
                celular.
              </p>
              <small>
                É o mesmo sistema, com os dados reais da agência, que você vai ver na conversa. Sem
                depoimento encomendado, sem contador de clientes, sem logo emprestado. Quando houver
                caso de outra agência, ele entra aqui com nome e autorização.
              </small>
            </div>
          </div>
        </section>
        ...
        <section className="lc-sec" id="faq" aria-labelledby="faq-titulo">
          <div className="lc-wrap">
            <div className="lc-cabeca">
              ...
              <h2 className="lc-h2" id="faq-titulo">
                O que costumam perguntar antes da conversa.
              </h2>
            </div>
      ...
      <footer className="lc-rodape">
        <div className="lc-wrap lc-rodape-in">
          <div>
            <strong style={{ color: "#efefef" }}>ARK Content</strong>. WorkFlowArk® é software da
            ARK Content.
          </div>
