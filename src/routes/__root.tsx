...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Agency Sync Hub centralizes advertising agency operations by integrating calendars, finances, and client communications." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Gestão de Agência" },
      { name: "twitter:description", content: "Agency Sync Hub centralizes advertising agency operations by integrating calendars, finances, and client communications." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd9efc02-0656-4783-b2a4-c75fb1629a17/id-preview-1cadd02b--5d091343-30b6-4eae-a57a-8ff66cdff118.lovable.app-1780507122694.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd9efc02-0656-4783-b2a4-c75fb1629a17/id-preview-1cadd02b--5d091343-30b6-4eae-a57a-8ff66cdff118.lovable.app-1780507122694.png" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "apple-touch-icon", href: "/ark-mark.png?v=2" },
      { rel: "icon", type: "image/png", href: "/ark-mark.png?v=2" },
    ],
  }),
